...
class CreateBookViewModel(private val repository: LibraryRepository) : ViewModel() {
    ...
    fun createBook(token: String, title: String, edition: String, author: String, publisher: String, publisherDate: String, copies: String, source: String, remark: String, price: Double){
        isLoading.value = true
        val book = Book(title, edition, author, publisher, publisherDate, copies, source, remark, price )
